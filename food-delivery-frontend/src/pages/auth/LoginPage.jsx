              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Button
                    ...
                    className="bg-[#9c2a59] hover:bg-[#7f1d5b] text-white text-sm px-4 py-2 rounded-[6px]"
                  >
                    Sign up
                  </Button>
                </>
              ...
              <div className="flex flex-col space-y-3 mt-2 px-2">
                {isAuthenticated ? (
                  ...
                  <>
                    ...
                    <Button variant="primary" onClick={() => { setMobileMenuOpen(false); navigate('/auth/register'); }} className="w-full bg-[#be185d] hover:bg-[#7f1b5a] text-white px-4 py-2 rounded-[6px]">
                      Sign up
                    </Button>
                  </>
                )}
      ...
      <main className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <Button type="submit" variant="primary" size="lg" className="w-full bg-[#ce2370] hover:bg-[#941136]" loading={loading}>
              Sign in
            </Button>

            <div className="text-center">
              <Link to="/auth/register" className="text-green-900 hover:text-[#0b5e23]">
